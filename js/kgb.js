  ...
  <div class="sk-kgb-print" id="sk-kgb-content" style="font-family:'Times New Roman',serif;font-size:12pt;color:#000">
    ...
    <table style="width:100%;border-bottom:3px solid #000;margin-bottom:8pt;border-collapse:collapse">
      <tr>
        <td style="width:70px;text-align:center;vertical-align:middle">
          ${_logoData?`<img src="${_logoData}" style="width:60px;height:60px;object-fit:contain">`:'<div style="width:60px;height:60px;border:1px solid #000;display:flex;align-items:center;justify-content:center;font-size:8pt">LOGO</div>'}
        </td>
        <td style="text-align:center;vertical-align:middle">
          <div style="font-size:12pt;font-weight:bold">PEMERINTAH PROVINSI KALIMANTAN SELATAN</div>
          <div style="font-size:14pt;font-weight:bold">BADAN PENGELOLAAN KEUANGAN DAN ASET DAERAH</div>
          <div style="font-size:9pt">Jl. Raya Dharma Praja, Banjarbaru Kalimantan Selatan (Kawasan Perkantoran Pemerintah Provinsi Kalimantan Selatan)</div>
          <div style="font-size:9pt">Laman : https://bpkad.kalselprov.go.id, Pos-el : bpkad@kalselprov.go.id</div>
        </td>
      </tr>
    </table>

    <!-- TANGGAL & NOMOR SURAT -->
    <div style="text-align:right;margin-bottom:8pt">Banjarbaru, ${fmtTglIndoStr(tglSurat)}</div>
    <table style="width:100%;margin-bottom:14pt;border-collapse:collapse">
      <tr><td style="width:90px">Nomor</td><td style="width:10px">:</td><td>${nomorFull}</td></tr>
      <tr><td>Sifat</td><td>:</td><td>Biasa</td></tr>
      <tr><td>Lampiran</td><td>:</td><td>-</td></tr>
      <tr><td>Hal</td><td>:</td><td>Kenaikan Gaji Berkala PNS a.n. ${a.nama}</td></tr>
    </table>

    <!-- TUJUAN -->
    <table style="width:100%;margin-bottom:14pt;border-collapse:collapse">
      <tr>
        <td style="width:30px;vertical-align:top">Yth.</td>
        <td>Kepala Badan Pengelolaan Keuangan dan Aset Daerah Provinsi Kalimantan Selatan</td>
      </tr>
      <tr><td></td><td>u.p. Kepala Bidang Perbendaharaan, Akuntansi dan Pelaporan Keuangan Daerah</td></tr>
      <tr><td></td><td>di -</td></tr>
      <tr><td></td><td>tempat</td></tr>
    </table>
    ...
    <table style="width:100%;margin-bottom:10pt;border-collapse:collapse">
      <tr>
        ...
        <td style="width:200px;vertical-align:top">Nama dan Tanggal Lahir</td>
        <td style="width:10px;vertical-align:top">:</td>
        <td><strong>${a.nama}</strong> (${tglLahir ? fmtTglIndo(tglLahir) : '...........'})</td>
      </tr>
      <tr>
        <td>2.</td><td>NIP</td><td>:</td><td>${a.nip}</td>
      </tr>
      <tr>
        <td>3.</td><td>Pangkat (Gol.ruang) Jabatan</td><td>:</td>
        <td>${a.pangkat} / ${a.jabatan||'...'}</td>
      </tr>
      <tr>
        <td>4.</td><td>Kantor / Tempat</td><td>:</td>
        <td>Badan Pengelolaan Keuangan dan Aset Daerah Provinsi Kalimantan Selatan</td>
      </tr>
      <tr>
        <td>5.</td><td>Gaji Pokok Lama</td><td>:</td>
        <td>Rp ${num(gajiLama)},-</td>
      </tr>
    </table>

    <p style="text-align:justify;margin-bottom:6pt">(atas dasar surat/keputusan terakhir tentang gaji/pangkat yang ditetapkan)</p>

    <table style="width:100%;margin-bottom:14pt;border-collapse:collapse">
      <tr>
        <td style="width:20px">a.</td><td style="width:200px">Oleh Pejabat</td><td style="width:10px">:</td>
        <td>Gubernur Kalimantan Selatan</td>
      </tr>
      <tr>
        <td>b.</td><td>Tanggal / Nomor</td><td>:</td>
        <td>${tglNomorSblm||'...........'}</td>
      </tr>
      <tr>
        <td>c.</td><td>Terhitung mulai tanggal berlakunya gaji tersebut</td><td>:</td>
        <td>${fmtTglIndoStr(tmtSblm)}</td>
      </tr>
      <tr>
        <td>d.</td><td>Masa Kerja Golongan</td><td>:</td>
        <td>${mkLamaStr}</td>
      </tr>
    </table>

    <p style="margin-bottom:10pt">Diberikan kenaikan gaji berkala hingga memperoleh :</p>

    <table style="width:100%;margin-bottom:20pt;border-collapse:collapse">
      <tr>
        <td style="width:20px">6.</td><td style="width:200px">Gaji Pokok Baru</td><td style="width:10px">:</td>
        <td><strong>Rp ${num(gajiBaru)},-</strong></td>
      </tr>
      <tr>
        <td>7.</td><td>Berdasarkan Masa Kerja</td><td>:</td>
        <td>${mkBaruStr}</td>
      </tr>
      <tr>
        <td>8.</td><td>Dalam Golongan</td><td>:</td>
        <td>${gol}</td>
      </tr>
      <tr>
        <td>9.</td><td>Terhitung Mulai Tanggal</td><td>:</td>
        <td>${fmtTglIndoStr(tglPenetapan)}</td>
      </tr>
      <tr>
        <td>10.</td><td>Kenaikan Gaji Berkala Berikutnya</td><td>:</td>
        <td>${fmtTglIndoStr(tglBerikutnya)}</td>
      </tr>
    </table>
    ...
    <!-- TTD -->
    <table style="width:100%;border-collapse:collapse;margin-bottom:40pt">
      <tr>
